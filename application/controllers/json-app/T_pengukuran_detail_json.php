...
class T_pengukuran_detail_json extends CI_Controller
{
	...
	function add()
	{
		...
		$reqJenisPengukuranId= $this->input->post("reqJenisPengukuranId");
		$reqNama= $this->input->post("reqNama");
		$reqHasil= $this->input->post("reqHasil");
		$reqKomentarId= $this->input->post("reqKomentarId");
		$reqStatus= $this->input->post("reqStatus");
		$reqIdPengukuran= $this->input->post("reqIdPengukuran");
		$reqRlaId= $this->input->post("reqRlaId");

		$set = new TPengukuranDetail();
		$set->setField("FORM_UJI_ID", $reqFormUjiId);
		$set->setField("JENIS_PENGUKURAN_ID", ValToNullDB($reqJenisPengukuranId));
		$set->setField("NAMA", $reqNama);
		$set->setField("HASIL", $reqHasil);
		$set->setField("KOMENTAR_ID", ValToNullDB($reqKomentarId));
		$set->setField("STATUS", ValToNullDB($reqStatus));

		$set->setField("T_PENGUKURAN_DETAIL_ID", $reqId);
		$set->setField("T_PENGUKURAN_ID", $reqIdPengukuran);
		$set->setField("PLAN_RLA_ID", $reqRlaId);
