...
class Group_state_json extends CI_Controller
{
	...
	function add_detail()
	{
		...
		$reqStateId= $this->input->post("reqStateId");
		$reqTipeId= $this->input->post("reqTipeId");
		$reqIndex= $this->input->post("reqIndex");

		$set = new GroupState();
		$set->setField("STATE_ID", $reqStateId);
		$set->setField("TIPE", $reqTipeId);
		$set->setField("URUT", $reqIndex);
		$set->setField("GROUP_STATE_ID", $reqHead);
		$set->setField("GROUP_STATE_DETAIL_ID", $reqId);
