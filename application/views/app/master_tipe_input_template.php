...
$objPHPexcel = PHPExcel_IOFactory::load('template/tipe_input.xlsx');
...
$objWorksheet->setCellValue("A1","TIPE_PENGUKURAN_ID");
...
$field= array();
$field= array("TIPE_PENGUKURAN_ID", "NAMA");

$statement=" ORDER BY TIPE_PENGUKURAN_ID ASC";
...
$objWriter->save('template/export/tipe_input.xls');

$down = 'template/export/tipe_input.xls';
