            ...
            <div class='col-md-12'>
               <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                ...
                ?>
                    ...
                    ?>
                    <div class="container">
                        <div class="page-header headernew class_header_<?=$reqKelompokEquipmentId?>" id="<?=$reqKelompokEquipmentId?>" style="background: #ff0655">
                        ...
                        <div class="content_check_<?=$reqKelompokEquipmentId?>" id="tabel_<?=$reqKelompokEquipmentId?>_<?=$reqTabelId?>_<?=$reqFormUjiId?>_<?=$reqPengukuranId?>">
