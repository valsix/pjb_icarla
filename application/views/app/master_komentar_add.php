...
else
{
	...
	$statement = " AND A.KOMENTAR_ID = '".$reqId."' ";
    $set->selectByParams(array(), -1, -1, $statement);
    // echo $set->query;exit;
    $set->firstRow();
    $reqId= $set->getField("KOMENTAR_ID");
    $reqKomentar= $set->getField("NAMA");
}
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                     <textarea class="easyui-validatebox textbox form-control" name="reqKomentar"  id="reqKomentar"  <?=$disabled?>><?=$reqKomentar?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/komentar_json/add',
        onSubmit:function(){
