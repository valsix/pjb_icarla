...
// $link="template/jenis_pengukuran.xls";
$link="app/loadUrl/app/master_jenis_pengukuran_template";
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/jenis_pengukuran',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alert('Info', infoSimpan ,null,function(){
                    top.location.href= "app/index/master_jenis_pengukuran";
                });
        }
    });
}
