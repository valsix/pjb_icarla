...
$arrtabledata= array(
    ...
    , array("label"=>"Kode Form Uji", "field"=> "KODE", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Nama Form Uji", "field"=> "NAMA", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Status", "field"=> "INFO_STATUS", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"DELETE_CHECK", "field"=> "DELETE_CHECK", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")

    , array("label"=>"fieldid", "field"=> "FORM_UJI_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<div class="col-md-12">
    ...
    <div class="konten-area">
    	<div id="bluemenu" class="aksi-area">
            ...
            <span><a id="btnCopy"><i class="fa fa-copy fa-lg" aria-hidden="true"></i> Copy</a></span>
            <?   
            }
            if($reqUpdate ==1)
            {
            ...
            {
            ?>
            <span><a id="btnImport"><i class="fa fa-file-excel-o fa-lg" aria-hidden="true"></i> Import Header</a></span>
            <?
            }
            ?>
        </div>
...
<script type="text/javascript">
    ...
    var indexfieldcheck= arrdata.length - 2;
	var valinfoid= valinforowid= valcheckhapus='';
	...
	$("#btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_form_uji_add?reqId="+valinfoid;
        document.location.href = varurl;
    });

    $("#btnAdd").on("click", function () {
        btnid= $(this).attr('id');
        varurl= "app/index/master_form_uji_add?reqId=";
        document.location.href = varurl;
    });
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_form_uji_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("app/index/master_form_uji_import");
    });

     $('#btnImportIsi').on('click', function () {
        if(valinfoid == "")
        {
            $.messager.alert('Info', "Pilih salah satu data terlebih dahulu.", 'warning');
            return false;
        }
        openAdd("app/index/master_form_uji_import_isi?reqId="+valinfoid);
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        if(valcheckhapus == 1)
        {
            $.messager.alert('Info', "Data tidak bisa dihapus, data sudah dipakai di plan rla", 'warning');
             return false;
        }

        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/form_uji_json/delete/?reqId="+valinfoid,
                    function(data){
    ...
    $("#btnCopy").on("click", function () {
        ...
        $.messager.confirm('Konfirmasi',"Copy data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/form_uji_json/copy/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/form_uji_json/json?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/form_uji_json/json";
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                fieldinfocheck= arrdata[indexfieldcheck]["field"];
                valinfoid= dataselected[fieldinfoid];
                valcheckhapus= dataselected[fieldinfocheck];
