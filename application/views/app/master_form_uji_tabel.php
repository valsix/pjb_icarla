...
<body>
      ...
      foreach ($arrpengukuran as $key => $value) 
      {
        ...
        ?>
          <div id="divpengukuran<?=$pengukuranid?>">
           <div class="page-header headernew class_header_<?=$pengukuranid?>" id="<?=$pengukuranid?>" style="background: #adb000">
            ...
            if($statustabel== 'TABLE')
            {
              ...
              if(empty($reqLihat))
              {
                ...
                <a href="javascript:void(0)" class="btn btn-danger" onclick="delete_data('<?=$pengukuranid?>','<?=$tabelid?>','<?=$reqId?>')">Hapus Tabel</a>
                <?
              }
              ?>
                  ...
                  <div class='form-group'>
                    ...
                    <?
                      ...
                      while($setisi->nextRow())
                      {
                        ...
                        $reqNamaKolom= $setisi->getField("NAMA");
                      ?>
                      <!--  <textarea id="check-<?=$reqFormDetilId?>" <?=$disabled?>  name="reqNamaKolom[]" style="width:100%;display: none;"><?=$reqNamaKolom?></textarea> -->
                      <input class='easyui-validatebox textbox form-control' type='hidden' name='reqNamaKolom[]' id='check-<?=$reqFormDetilId?>' value='<?=$reqNamaKolom?>' data-options='' style='width:100%'>
                    ...
                    <?
                     ...
                     {
                      ?>
                      <!--  <textarea  name="reqNamaKolom[]"  id="check-<?=$pengukuranid?>-<?=$z?>"  style="width:100%;display: none"></textarea> -->
                       <input class='easyui-validatebox textbox form-control' type='hidden' name='reqNamaKolom[]' id='check-<?=$pengukuranid?>-<?=$z?>' value='<?=$valuenama?>' data-options='' style='width:100%'>
                  ...
                  <div class='form-group'>
                    <div class='col-md-11'>
                      ...
                      while($setisi->nextRow())
                      {
                        ...
                        $reqNamaKolom= $setisi->getField("NAMA");
                        ?>
                        <input class='easyui-validatebox textbox form-control' <?=$disabled?> type='hidden' name='reqNamaKolom[]' id='reqNamaKolom' value='<?=$reqNamaKolom?>' data-options='' style='width:100%' maxlength="25">
                      ...
                      {
                        ?>
                        <input class='easyui-validatebox textbox form-control' type='hidden' name='reqNamaKolom[]' id='reqNamaKolom' value='' data-options='' style='width:100%' maxlength="25">
                        <input class='easyui-validatebox textbox form-control' type='hidden' name='reqStatusTabel[]' id='reqStatusTabel' value='ANALOG' data-options='' style='width:100%'>
                        <input type='hidden' name='reqFormDetilId[]' id='reqFormDetilId' value='<?=$reqFormDetilId?>' >
                        <input type='hidden' name='reqTabelId[]' id='reqTabelId' value='' >
                        <input type='hidden' name='reqPengukuranId[]' id='reqPengukuranId' value='<?=$pengukuranid?>' >
...
<script type="text/javascript">
  ...
  function delete_data(pengukuranid,reqTabelId,reqId) {
    $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
      if (r){
        $.getJSON("json-app/form_uji_json/deletetabel/?reqId="+reqId+"&reqTabelId="+reqTabelId+"&reqPengukuranId="+pengukuranid,
          function(data){
