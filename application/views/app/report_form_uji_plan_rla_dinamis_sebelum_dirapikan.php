                    ...
                    ?>
                        <div>
                            ...
                            <div style="<?=$margin?>">
                                ...
                                <a href="javascript:void(0)" class="btn btn-success class_cetak_<?=$reqKelompokEquipmentId?>" onclick="cetak_excel('<?=$reqKelompokEquipmentId?>')">Cetak Excel</a>
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                        ...
                                                                        if($z==1)
                                                                        {
                                                                            ?>
                                                                            <td ><?=$reqNamaMaster?>
                                                                                <input class='easyui-validatebox textbox form-control'  type="hidden" name="reqNamaKolom[]" value="<?=$reqNamaMaster?>"></td>
                                                                            </td>
                                                                            <?
                                                                        }
                                                                        else
                                                                        {
                                                                            ...
                                                                            <td id="edit-<?=$tabelid?>-<?=$reqPengukuranId?>-<?=$reqFormUjiId?>-<?=$reqKelompokEquipmentId?>-<?=$pengukurantipeid?>" ><input id="reqNamaKolom-<?=$tabelid?>-<?=$reqPengukuranId?>-<?=$pengukurantipeid?>" class='easyui-validatebox textbox form-control isitext-<?=$tabelid?>-<?=$reqPengukuranId?>-<?=$reqFormUjiId?>-<?=$reqKelompokEquipmentId?>-<?=$pengukurantipeid?>'  type="hidden" name="reqNamaKolom[]" value=""> <span></span></td>
