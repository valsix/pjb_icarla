...
else
{
	...
	$statement = " AND A.UOM_ID = '".$reqId."' ";
    $set->selectByParams(array(), -1, -1, $statement);
    // echo $set->query;exit;
    $set->firstRow();
    $reqId= $set->getField("UOM_ID");
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">  
                        <label class="control-label col-md-2">Nama Uom </label>
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                    ...
                                    data-options="width:'100',editable:false,valueField:'id',textField:'text',url:'json-app/combo_json/combostatusaktif'" value="<?=$reqStatus?>" <?=$disabled?> required />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                     <input autocomplete="off" class="easyui-validatebox textbox form-control" type="text" name="reqFunction"  id="reqFunction" value="<?=$reqFunction?>" <?=$disabled?> style="width:100%" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                     <input autocomplete="off" class="easyui-validatebox textbox form-control" type="text" name="reqKeterangan"  id="reqKeterangan" value="<?=$reqKeterangan?>" <?=$disabled?> style="width:100%" />
                                </div>
                            </div>
                        </div>
                    </div>
