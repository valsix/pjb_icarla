...
else
{
    ...
    $reqWorkOrderNo= $set->getField("WO_NO");
    $reqWorkOrderProject= $set->getField("WO_PROJECT");
    ...
    $reqKelompokEquipment= getmultiseparator(str_replace(" ", "", $set->getField("PLAN_RLA_KELOMPOK_EQUIPMENT_ID_INFO")));
    unset($set);
...
// var_dump($disabledfinish);

$vgl= new globalfunc();
$arrkelompokequipment= $vgl->getkelompokequipmenttree([]);
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    <ul class="nav nav-pills mr-auto">
                        ...
                        if($vstatus==20 &&  ($reqMenuUmro == 1 ||  $reqTimMenuUmro == 1))
                        {
                            ?>
                            <li class="nav-item ">
                                <a class="nav-link " href="app/index/summary_rekomendasi?reqIdRla=<?=$reqId?>&reqLihat=<?=$reqLihat?>"> &nbsp;Summary dan Rekomendasi</a>
                            </li>
                            <?
                        }
                        ?>
                    ...
                    <div class="tab-content">
                        <div id="master" class="tab-pane fade in active">
                            ...
                            <?
                            if($vstatus==20 && $reqTimMenuUmro==1 )
                            {
                            ?>
                                <div class="form-group">  
                                    <label class="control-label col-md-2">Status Finish</label>
                                    <div class='col-md-8'>
                                        <div class='form-group'>
                                            <div class='col-md-2'>
                                               <input autocomplete="off"   type="checkbox" <?if($reqFinish==1) echo 'checked'; ?> name="reqFinish" id="reqFinish" value="1"   />
                                           </div>
                                       </div>
                                   </div>
                                </div>
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-11'>
                                            <select class="form-control" id="reqKelompokEquipment" <?=$disabled?> name="reqKelompokEquipment[]" style="width:100%;" multiple="multiple">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-11'>
                                            <input autocomplete="off" <?=$disabledfinish?> class="easyui-validatebox textbox form-control" type="text" name="reqRlaIndex"  id="reqRlaIndex" value="<?=$reqRlaIndex?>" style="width:100%"   <?=$disabledapp?>/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-11'>
                                            <input autocomplete="off"  <?=$disabledfinish?> class="easyui-validatebox textbox form-control" type="text" name="reqAnggaranRealisasi"  id="reqAnggaranRealisasi" value="<?=$reqAnggaranRealisasi?>" style="width:100%"   <?=$disabledapp?>/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class='form-group'>
                                        <div class='col-md-11'>
                                            <input type="hidden" name="reqWorkOrderId" id="reqWorkOrderId" value="<?=$reqWorkOrderId?>" style="width:100%" />
                                             <input autocomplete="off" class="easyui-validatebox textbox form-control" type="text" name="reqWorkOrderNo"  id="reqWorkOrderNo" value="<?=$reqWorkOrderNo?>" style="width:100%" readonly />
                                            ...
                                            <input autocomplete="off" class="easyui-validatebox textbox form-control" type="text" name="reqWorkOrderProject"  id="reqWorkOrderProject" value="<?=$reqWorkOrderProject?>" style="width:100%" readonly />
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-12'>
                                            <input autocomplete="off" class="easyui-datebox form-control" type="text" name="reqRencanaTanggalAwal"  id="reqRencanaTanggalAwal" value="<?=$reqRencanaTanggalAwal?>" style="width:100%"   <?=$disabled?>   />
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-12'>
                                            <input autocomplete="off"  <?=$disabledfinish?> class="easyui-datebox form-control" type="text" name="reqRealisasiTanggalAwal"  id="reqRealisasiTanggalAwal" value="<?=$reqRealisasiTanggalAwal?>" style="width:100%"  <?=$disabledapp?> />
                                            <label style="margin-left: 15px">Tanggal Akhir</label>
                                            <input autocomplete="off"  <?=$disabledfinish?> class="easyui-datebox form-control" type="text" name="reqRealisasiTanggalAkhir"  id="reqRealisasiTanggalAkhir" value="<?=$reqRealisasiTanggalAkhir?>" style="width:100%"   <?=$disabledapp?>/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-11'>
                                            <input autocomplete="off" readonly class="easyui-validatebox textbox form-control" type="text" name="reqDurasiRealisasi"  id="reqDurasiRealisasi" value="<?=$reqDurasiRealisasi?>" style="width:50%"  <?=$disabledapp?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class='form-group'>
                                        <div class='col-md-3'>
                                           <!--  <input  name="reqTimelineRlaId" class="easyui-combobox form-control" id="reqTimelineRlaId"
                                            ...
                                            <input autocomplete="off"  <?=$disabledfinish?> class="easyui-validatebox textbox form-control" type="text" name="reqProgress"  id="reqProgress" value="<?=$reqProgress?>" style="width:60%"   <?=$disabledapp?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- 
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-4'>
                                    <div class='form-group'>
                                        <div class='col-md-12'>
                                             <span   style="background-color: green;padding: 8px; border-radius: 5px;color: white"><a onclick="openTemplate('<?=$reqId?>','<?=$disabledfinish?>')"><i class="fa fa-download fa-lg" style="color: white;" aria-hidden="true"></i></a> </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <input type="hidden" name="reqVstatus" value="<?=$vstatus?>" />
...
<script>
    arrkelompokequipment= JSON.parse('<?=JSON_encode($arrkelompokequipment)?>');
    // console.log(arrkelompokequipment);
    $("#reqKelompokEquipment").select2ToTree({treeData: {dataArr: arrkelompokequipment}, placeholder: 'Pilih salah satu data'});
    reqKelompokEquipment= JSON.parse('<?=JSON_encode($reqKelompokEquipment)?>');
    // console.log(reqKelompokEquipment);
    $('#reqKelompokEquipment').val(reqKelompokEquipment).trigger('change');
...
function setWO(values)
{
    ...
    $('#reqWorkOrderNo').val(values.WO);
    $('#reqWorkOrderNama').val(values.DESCRIPTION);
    $('#reqWorkOrderProject').val(values.PROJECT_NO);
}
...
function openTemplate(reqId,finish)
{
    // console.log(finish);
    if(finish=="disabled")
    {
