...
$arrtabledata= array(
    ...
    , array("label"=>"Nama Distrik", "field"=> "NAMA", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Kode ", "field"=> "KODE", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Kode Site ", "field"=> "KODE_SITE", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Nama Perusahaan", "field"=> "NAMA_PERUSAHAAN", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")

    , array("label"=>"fieldid", "field"=> "DISTRIK_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);

$set= new Crud();
$statement=" AND KODE_MODUL ='0101'";
$kode= $appuserkodehak;
...
<script type="text/javascript">
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/distrik_json/json?reqPencarian="+reqPencarian;
