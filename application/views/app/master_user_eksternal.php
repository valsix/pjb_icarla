...
$arrtabledata= array(
    ...
    , array("label"=>"Nama Lengkap", "field"=> "NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Email", "field"=> "EMAIL", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Role", "field"=> "ROLE_INFO", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Perusahaan", "field"=> "PERUSAHAAN_EKSTERNAL_INFO", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
       ...
       if(btnid=="btnAdd")
        ...
        varurl= "app/index/master_user_eksternal_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_user_eksternal_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });
    ...
    $("#btnReset").on("click", function () {
        ...
        varurl= "app/index/master_user_eksternal_reset?reqId="+valinfoid;
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("app/index/master_user_eksternal_import");
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/user_json/delete/?reqId="+valinfoid,
                    function(data){
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/user_json/json?reqPencarian="+reqPencarian;
