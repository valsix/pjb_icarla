...
<script type="text/javascript">
    ...
    //     // var reqDistrikId=$('#reqDistrikId').val();
    //     jsonurl= "json-app/work_json/json_work_order?reqDistrikId="+reqDistrikId;
    //     datanewtable.DataTable().ajax.url(jsonurl).load();
    // });
        ...
        $.messager.confirm('Konfirmasi',"Generate data ?",function(r){
            ...
            if (r){
                $.ajax({
                    ...
                    setTimeout(function(){  document.location.href = "iframe/index/work_order?reqDistrikId="+reqDistrikId+'&reqEquipmentId='+reqEquipmentId; }, 3000); 
                }
            });
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/work_json/json_work_order?reqDistrikId="+reqDistrikId+'&reqEquipmentId='+reqEquipmentId;
