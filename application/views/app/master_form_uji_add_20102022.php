...
function kondisiTipe(reqTipe){
    ...
    console.log(reqTipe);
            ...
            //  $.ajax({  
            //   type: "GET",                                    
            //   url: "app/loadUrl/app/master_form_uji_tabel?reqTipePengukuranId="+reqTipe+"&reqId=<?=$reqId?>",
            //   beforeSend: function(){
...
function import_tipe(tipe,tabelid) {
    openAdd("app/index/master_form_uji_import_tipe?reqId=<?=$reqId?>&reqPengukuranId="+tipe+"&reqTabelId="+tabelid);
}
