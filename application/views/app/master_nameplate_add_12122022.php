                        ...
                        <table class="table table-bordered table-striped table-hovered" style="margin-top: 10px;width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="vertical-align : middle;text-align:center;width: 55%">Kolom</th>
                            ...
                            <tbody id="tableNameplate">
                              ...
                              foreach($arrdetil as $itemdetil) 
                              {
                                ...
                                <tr  id="nameplatedetil-<?=$selectvaliddetil?>">
                                    ...
                                    ?>
                                        <td>
                                            <select class="form-control jscaribasicmultiple" name='reqTipe[]' style="width:100%;" >
                                                ...
                                                foreach($arrtabel as $item) 
                                                {
                                                    ...
                                                    ?>
                                                    <option value="<?=$selectnama?>" <?=$selected?>><?=$selectinfo?></option>
                                                    <?
                                                }
                                                ?>  
                                            </select>
...
function AddNameplate(tipe) {
    if(tipe==1)
    {
        var url = "app/loadUrl/app/template_nameplate_add?reqTipe="+tipe;
    }
    else
    {
