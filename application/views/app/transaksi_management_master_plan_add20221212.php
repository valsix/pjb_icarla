                        ...
                        <div id="master" class="tab-pane fade in active">
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-11'>
                                            <input autocomplete="off" class="easyui-validatebox textbox form-control" type="text" name="reqRlaIndex"  id="reqRlaIndex" value="<?=$reqRlaIndex?>" style="width:100%"   <?=$disabledapp?>/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-11'>
                                            <input autocomplete="off" class="easyui-validatebox textbox form-control" type="text" name="reqAnggaranRealisasi"  id="reqAnggaranRealisasi" value="<?=$reqAnggaranRealisasi?>" style="width:100%"   <?=$disabledapp?>/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">  
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-12'>
                                            <input autocomplete="off" class="easyui-datebox form-control" type="text" name="reqRealisasiTanggalAwal"  id="reqRealisasiTanggalAwal" value="<?=$reqRealisasiTanggalAwal?>" style="width:100%"  <?=$disabledapp?> />
                                            <label style="margin-left: 15px">Tanggal Akhir</label>
                                            <input autocomplete="off" class="easyui-datebox form-control" type="text" name="reqRealisasiTanggalAkhir"  id="reqRealisasiTanggalAkhir" value="<?=$reqRealisasiTanggalAkhir?>" style="width:100%"   <?=$disabledapp?>/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class='form-group'>
                                        <div class='col-md-3'>
                                           <!--  <input  name="reqTimelineRlaId" class="easyui-combobox form-control" id="reqTimelineRlaId"
                                            ...
                                            <input autocomplete="off" class="easyui-validatebox textbox form-control" type="text" name="reqProgress"  id="reqProgress" value="<?=$reqProgress?>" style="width:60%"   <?=$disabledapp?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
