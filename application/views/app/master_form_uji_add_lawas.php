...
else
{
    ...
    $reqEquipmentId= getmultiseparator($set->getField("FORM_UJI_KELOMPOK_EQUIPMENT_ID_INFO"));
    ...
    while($set->nextRow())
    {
        ...
        $arrdata["text"]= $set->getField("NAMA");
        array_push($arrequipment, $arrdata);
    }
                                ...
                                <div class='col-md-8'>
                                    <div class='form-group'>
                                        <div class='col-md-11'>
                                            ...
                                            <select class="form-control jscaribasicmultiple" id="reqEquipmentId" <?=$disabled?> name="reqEquipmentId[]" style="width:100%;" multiple="multiple">
                                                <?
                                                foreach($arrequipment as $item) 
                                                {
                                                    $selectvalid= $item["id"];
                                                    $selectvaltext= $item["text"];
                                                    $selectdetil= $item["FORM_UJI_KELOMPOK_EQUIPMENT_ID"];

                                                    $selected="";
                                                    if(in_array($selectvalid, $reqEquipmentId))
                                                    {
                                                        $selected="selected";
                                                    }
                                                    ?>
