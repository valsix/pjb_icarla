...
$arrtabledata= array(
    ...
    , array("label"=>"Form Uji", "field"=> "FORM_UJI", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Jenis Pengukuran", "field"=> "JENIS_PENGUKURAN", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Nama", "field"=> "NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Hasil", "field"=> "HASIL", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Komentar", "field"=> "KOMENTAR", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")

    , array("label"=>"fieldid", "field"=> "T_PENGUKURAN_DETAIL_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
?>
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/transaksi_detail_pengukuran_add?reqId="+valinfoid;
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/t_pengukuran_detail_json/delete/?reqId="+valinfoid,
                    function(data){
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/t_pengukuran_detail_json/json?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/t_pengukuran_detail_json/json";
