...
$arrtabledata= array(
    ...
    , array("label"=>"Nama EAM", "field"=> "NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Keterangan", "field"=> "KETERANGAN", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"URL Web Service", "field"=> "URL", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
...
<script type="text/javascript">
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/eam_json/json?reqPencarian="+reqPencarian;
