...
else
{
	...
	$statement = " AND ENJINIRINGUNIT_ID = '".$reqId."' ";
    $set->selectByParams(array(), -1, -1, $statement);
    // echo $set->query;exit;
    $set->firstRow();
    $reqId= $set->getField("ENJINIRINGUNIT_ID");
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">  
                        <label class="control-label col-md-2">Kode EU</label>
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                    ...
                    <div class="form-group">  
                        <label class="control-label col-md-2">Nama EU</label>
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
...
function submitForm(){
    ...
    $('#ff').form('submit',{
        url:'json-app/enjiniring_unit_json/add',
        onSubmit:function(){
