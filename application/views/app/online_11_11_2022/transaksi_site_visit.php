...
$arrtabledata= array(
     array("label"=>"Report Number", "field"=> "GENERAL_REPORT", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Tanggal Site Visit", "field"=> "GENERAL_TANGGAL_SITE", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Name Of Part", "field"=> "GENERAL_NAME", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Drawing No", "field"=> "GENERAL_DRAWING", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"fieldid", "field"=> "SITE_VISIT_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<div class="col-md-12">
    ...
    <div class="konten-area">
    	<div id="bluemenu" class="aksi-area">
            ...
            ?>
            <!-- <span><a id="btnImport"><i class="fa fa-upload fa-lg" aria-hidden="true"></i> Import</a></span>
            <span><a id="btnStatus"><i class="fa fa-window-restore fa-lg" aria-hidden="true"></i> Ubah Status</a></span> -->
        </div>

        <div class="area-filter">
        	<!-- <label>Status :</label>
            <input name="reqStatus" class="easyui-combobox form-control" id="reqStatus"
            data-options="width:'120',editable:false,valueField:'id',textField:'text',url:'web/combo_json/comboStatusAktif'" value="AKTIF" style="color:#FFFFFF !important" />

        	<label>Main Area :</label>
            <input name="reqUnit" class="easyui-combotree form-control" id="reqUnit"
            data-options="width:'500',panelHeight:'400',editable:false,valueField:'id',textField:'text',url:'web/main_area_json/combotree'" value="" style="color:#FFFFFF !important" /> -->
		</div>
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/transaksi_site_visit_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/transaksi_site_visit_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/site_visit_json/delete/?reqId="+valinfoid,
                    function(data){
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/site_visit_json/json?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/site_visit_json/json?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun=<?=$reqTahun?>";
