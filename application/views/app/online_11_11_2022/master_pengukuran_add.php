                                                ...
                                                <tbody id="tableTipeUkuran">
                                                        ...
                                                        foreach($arrTipeInput as $item) 
                                                        {
                                                            ...
                                                            <tr id="irpibeforedetil-<?=$selectvalid?>" >
                                                                ...
                                                                <td><input class='easyui-validatebox textbox form-control' type='text' name='reqSeq[]' id='reqSeq' value='<?=$seq?>' data-options='' style='width:100%'>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <div id="reqTipePengukuranField-<?=$pengukuran_tipe_input_id?>" style="<?if(in_array( $tipe_input_id ,$arrShowHide['TABLE'] )){}else{?> display: none !important<?}?>">
                                                                        <select class="form-control jscaribasicmultiple " id="reqTipePengukuran-<?=$pengukuran_tipe_input_id?>" <?=$disabled?> name="reqTipePengukuranTable[]" style="width:50%; <?if(in_array( $tipe_input_id ,$arrShowHide )){}else{?> display: none !important<?}?>;">
                                                                            <?
                                                                        ...
                                                                        <span style="background-color: green;padding: 8px; border-radius: 5px;color: white"><a onclick="openPreview(<?=$pengukuran_tipe_input_id?>)">Preview</a> </span>
                                                                    </div>

                                                                    <div id="reqTipePengukuranFieldPic-<?=$pengukuran_tipe_input_id?>" style="<?if(in_array( $tipe_input_id ,$arrShowHide['PIC'] )){}else{?> display: none !important<?}?>">
                                                                        ...
                                                                        <input type="text" name="reqTipePengukuranGambar[]" value="<?=$value?>" class="easyui-validatebox textbox form-control" >
                                                                        <?
                                                                        if(!empty($value))
                                                                        {
                                                                        ?>
                                                                    ...
                                                                    <div id="reqTipePengukuranFieldText-<?=$pengukuran_tipe_input_id?>" style="<?if(in_array( $tipe_input_id ,$arrShowHide['TEXT'] )){}else{?> display: none !important<?}?>">
                                                                        <!-- <textarea style="width:100%" name="reqTipePengukuranDesc[]"><?=$value?></textarea> -->
                                                                        <input type="text" name="reqTipePengukuranDesc[]" value="<?=$value?>" class="easyui-validatebox textbox form-control" >
                                                                    </div>
                                                                    <div id="reqTipePengukuranFieldAnalog-<?=$pengukuran_tipe_input_id?>" style="<?if(in_array( $tipe_input_id ,$arrShowHide['ANALOG'] )){}else{?> display: none !important<?}?>">
                                                                        <input type="text" name="reqTipePengukuranAnalog[]" value="<?=$value?>" class="easyui-validatebox textbox form-control" >
                                                                    </div>
                                                                    <div id="reqTipePengukuranFieldBinary-<?=$pengukuran_tipe_input_id?>" style="<?if(in_array( $tipe_input_id ,$arrShowHide['BINARY'] )){}else{?> display: none !important<?}?>">
                                                                        <input type="text" name="reqTipePengukuranBinary[]" value="<?=$value?>" class="easyui-validatebox textbox form-control" >
                                                                    </div>
                                                                </td>
                                                                <?
...
function hapusTipeInput(val)
{
    $.messager.confirm('Konfirmasi',"Hapus Tipe Input?",function(r){
        if (r){
            $.getJSON("json-app/pengukuran_json/delete_tipeinput/?reqId="+val,
                function(data){
                    $.messager.alert('Info', data.PESAN, 'info');
                    valinfoid= "";
                    location.reload();
