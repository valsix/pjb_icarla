                    ...
                    <!-- <div id="testnew"> -->
                        ...
                        <div class="form-group">  
                            ...
                            <div class='col-md-4'>
                                <div class='form-group'>
                                    <div class='col-md-12'>
                                       <span style="background-color: green;padding: 8px; border-radius: 5px;color: white"><a onclick="openInput('<?=$reqId?>')"><i class="fa fa-plus fa-lg" style="color: white;" aria-hidden="true"></i></a> </span>
                                   </div>
                               </div>
                           </div>
                       </div>
...
function openInput(reqId)
{
    openAdd('app/index/master_pengukuran_tipe?reqId='+reqId);
} 
