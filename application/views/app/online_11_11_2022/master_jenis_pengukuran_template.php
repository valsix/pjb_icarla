...
$objPHPexcel = PHPExcel_IOFactory::load('template/jenis_pengukuran.xlsx');
...
$objWorksheet->setCellValue("A1","Form Uji ID");
...
$field= array();
$field= array("FORM_UJI_ID","KODE","NAMA");
...
$objWriter->save('template/export/jenis_pengukuran.xls');

$down = 'template/export/jenis_pengukuran.xls';
