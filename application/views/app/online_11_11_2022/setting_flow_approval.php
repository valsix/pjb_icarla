...
<script type="text/javascript">
    ...
    $("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/setting_flow_approval_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/setting_flow_approval_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/flow_approval_json/delete/?reqId="+valinfoid,
                    function(data){
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/flow_approval_json/json?reqPencarian="+reqPencarian;
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/flow_approval_json/json";
