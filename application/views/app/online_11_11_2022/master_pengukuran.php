...
$arrtabledata= array(
    ...
    , array("label"=>"Kode Pengukuran", "field"=> "KODE", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Nama Pengukuran", "field"=> "NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Jenis Pengukuran", "field"=> "NAMA_JENIS", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Nama  Pengukuran", "field"=> "NAMA_PENGUKURAN", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Formula", "field"=> "FORMULA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Satuan", "field"=> "Satuan", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Status", "field"=> "INFO_STATUS", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    // , array("label"=>"Type", "field"=> "TIPE_INPUT", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"PENGUKURAN_CHECK", "field"=> "PENGUKURAN_CHECK", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
  
    , array("label"=>"fieldid", "field"=> "PENGUKURAN_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);

$set= new Crud();
$statement=" AND KODE_MODUL ='0206'";
$kode= $appuserkodehak;
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_pengukuran_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_pengukuran_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("app/index/master_pengukuran_import");
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        if(valcheckhapus == 1)
        {
            $.messager.alert('Info', "Data tidak bisa dihapus, data sudah dipakai di form uji", 'warning');
             return false;
        }

        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/pengukuran_json/delete/?reqId="+valinfoid,
                    function(data){
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/pengukuran_json/json?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/pengukuran_json/json";
