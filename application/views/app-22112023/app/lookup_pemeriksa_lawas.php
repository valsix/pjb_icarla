            ...
            <!-- <div class="col-md-3 col-treegrid">
                <div class="konten">
                    <div id="infodetilparaf">
                        <label>Pejabat Terpilih:</label>
                        <button class="btn btn-primary btn-sm" type="button" onclick="setsatuankerjapilih()"><i class="fa fa-user-circle"></i> Ok</button>
                        <ol id="SortMe" class="ui-sortable">
                            <li class="ListItem">Inspektur Perencanaan &amp; Pengembangan Audit</li>
                            <li class="ListItem">Inspektur Operation Audit</li>
                            <li class="ListItem">Inspektur Support Function Audit</li>
                            <li class="ListItem">Inspektur Information Technology Audit</li>
                        </ol>
                        <div class="text-danger">
                            <i class="fa fa-info-circle" aria-hidden="true"></i> Ubah urutan pejabat dengan cara 
                            <strong><i>drag and drop</i></strong>
                        </div>
                    </div>
                </div>
            </div> -->
