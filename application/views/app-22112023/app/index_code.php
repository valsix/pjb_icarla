    ...
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <!-- <li class="nav-item">
                    <a class="nav-link" style="background:#235A81" href="role/modul"><i class="fa fa-window-restore fa-xs"></i> MODUL LOGSHEET</a>
                </li>
                <li>&nbsp;&nbsp;</li>
                <li class="nav-item">
                    <a class="nav-link" style="background:#235A81" href="role/entitas"><i class="fa fa-map-marker fa-xs"></i> <?=coalesce($this->CABANG, "ENTITAS BELUM DITENTUKAN")?></a>
                </li>
                <li>&nbsp;&nbsp;</li>
                <li class="nav-item">
                    <a class="nav-link logout" id="btnEAM" data-toggle="modal" data-target="#myModalEAM"><i class="fa fa-users fa-xs"></i> Konfigurasi EAM</a>
                </li>
                <li>&nbsp;&nbsp;</li> -->
                <li class="nav-item">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2" id="myDIV">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <!-- <li class="nav-item <?=(stristr($pg, "master_") ? "menu-is-opening menu-open" : "")?>">
                            <a href="#" class="nav-link <?=(stristr($pg, "master_") ? "active" : "")?>"><strong>Data Master</strong> 
                            <span class="<? if($pg == "" || $pg == "home"){ ?>caret<? } else {?>arrow-right<? } ?>"></span></a>
                            <ul class="nav nav-treeview">

                                <li class="nav-item">
                                    <a class="<?=($pg == "master_enjiniring_unit" ? "active" : "")?>" href="app/index/master_enjiniring_unit">Enjiniring Unit</a>
                                    <a class="<?=($pg == "master_state" ? "active" : "")?>" href="app/index/master_state">State</a>
                                    <a class="<?=($pg == "master_group_state" ? "active" : "")?>" href="app/index/master_group_state">Group State</a>
                                    <a class="<?=($pg == "master_distrik" ? "active" : "")?>" href="app/index/master_distrik">Distrik</a>
                                    <a class="<?=($pg == "master_perusahaan_eksternal" ? "active" : "")?>" href="app/index/master_perusahaan_eksternal">Perusahaan Eksternal</a>
                                    <a class="<?=($pg == "master_blok" ? "active" : "")?>" href="app/index/master_blok">Blok</a>
                                    <a class="<?=($pg == "master_unit" ? "active" : "")?>" href="app/index/master_unit">Unit</a>
                                    <a class="<?=($pg == "master_form_uji" ? "active" : "")?>" href="app/index/master_form_uji">Form Uji</a>
                                    <a class="<?=($pg == "master_manufaktur" ? "active" : "")?>" href="app/index/master_manufaktur">Manufaktur</a>
                                    <a class="<?=($pg == "master_measuring_tools" ? "active" : "")?>" href="app/index/master_measuring_tools">Measuring Tools</a>
                                    <a class="<?=($pg == "master_jenis_pengukuran" ? "active" : "")?>" href="app/index/master_jenis_pengukuran">Jenis Pengukuran</a>
                                    <a class="<?=($pg == "master_jabatan" ? "active" : "")?>" href="app/index/master_jabatan">Jabatan</a>
                                    <a class="<?=($pg == "master_pengukuran" ? "active" : "")?>" href="app/index/master_pengukuran">Pengukuran</a>
                                    <a class="<?=($pg == "master_eam" ? "active" : "")?>" href="app/index/master_eam">EAM</a>
                                    <a class="<?=($pg == "master_user" ? "active" : "")?>" href="app/index/master_user_eksternal">User Eksternal</a>
                                    <a class="<?=($pg == "master_tipe_input" ? "active" : "")?>" href="app/index/master_tipe_input">Tipe Input</a>
                                    <a class="<?=($pg == "master_uom" ? "active" : "")?>" href="app/index/master_uom">Uom</a>
                                    <a class="<?=($pg == "master_role" ? "active" : "")?>" href="app/index/master_role">Role</a>
                                </li>
                            </ul>
                        </li> -->
                        <li class="nav-item <?=(stristr($pg, "master_") ? "menu-is-opening menu-open" : "")?>">
                            <a href="#" class="nav-link <?=(stristr($pg, "master_") ? "active" : "")?>"><strong>Master Location</strong> 
                            <span class="<? if($pg == "" || $pg == "home"){ ?>caret<? } else {?>arrow-right<? } ?>"></span></a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a class="<?=($pg == "master_distrik" ? "active" : "")?>" href="app/index/master_distrik">Distrik</a>
                        ...
                        <li class="nav-item <?=(stristr($pg, "master_rla") ? "menu-is-opening menu-open" : "")?>">
                            <a href="#" class="nav-link <?=(stristr($pg, "master_rla") ? "active" : "")?>"><strong>Master Rla</strong> 
                            <span class="<? if($pg == "" || $pg == "home"){ ?>caret<? } else {?>arrow-right<? } ?>"></span></a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a class="<?=($pg == "master_enjiniring_unit" ? "active" : "")?>" href="app/index/master_enjiniring_unit">Enjiniring Unit</a>
                                    ...
                                    <a class="<?=($pg == "master_jenis_pengukuran" ? "active" : "")?>" href="app/index/master_jenis_pengukuran">Jenis Pengukuran</a>
                                    <a class="<?=($pg == "master_eam" ? "active" : "")?>" href="app/index/master_eam">EAM</a>
                                    <a class="<?=($pg == "master_komentar" ? "active" : "")?>" href="app/index/master_komentar">Komentar</a>
                                </li>
                            </ul>
                        </li>

                        <li class="nav-item <?=(stristr($pg, "master_user") ? "menu-is-opening menu-open" : "")?>">
                            <a href="#" class="nav-link <?=(stristr($pg, "master_user") ? "active" : "")?>"><strong>Master User</strong> 
                            <span class="<? if($pg == "" || $pg == "home"){ ?>caret<? } else {?>arrow-right<? } ?>"></span></a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a class="<?=($pg == "master_jabatan" ? "active" : "")?>" href="app/index/master_jabatan">Jabatan</a>
                                   <!--  <a class="<?=($pg == "master_jabatan_lama" ? "active" : "")?>" href="app/index/master_jabatan_lama">Jabatan Lama</a> -->
                                    <a class="<?=($pg == "master_user_eksternal" ? "active" : "")?>" href="app/index/master_user_eksternal">User Eksternal</a>
                                    <a class="<?=($pg == "master_user_internal" ? "active" : "")?>" href="app/index/master_user_internal">User Internal</a>
                                    <!-- <a class="<?=($pg == "master_role" ? "active" : "")?>" href="app/index/master_role">Role</a> -->
                                    <a class="<?=($pg == "master_pengguna" ? "active" : "")?>" href="app/index/master_pengguna">Pengguna</a>
                                </li>
                            </ul>
                        </li>

                        <li class="nav-item <?=(stristr($pg, "master_template") ? "menu-is-opening menu-open" : "")?>">
                            <a href="#" class="nav-link <?=(stristr($pg, "master_template") ? "active" : "")?>"><strong>Master Template</strong> 
                            <span class="<? if($pg == "" || $pg == "home"){ ?>caret<? } else {?>arrow-right<? } ?>"></span></a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a class="<?=($pg == "master_nameplate" ? "active" : "")?>" href="app/index/master_nameplate">Nameplate</a>
                                  
                                </li>
                            </ul>
                        </li>

                        <li class="nav-item <?=(stristr($pg, "transaksi_") ? "menu-is-opening menu-open" : "")?>">
                            <a href="#" class="nav-link <?=(stristr($pg, "transaksi_") ? "active" : "")?>"><strong>Transaksi</strong> 
                            <span class="<? if($pg == "" || $pg == "home"){ ?>caret<? } else {?>arrow-right<? } ?>"></span></a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                   <a class="<?=($pg == "transaksi_management_master_plan" ? "active" : "")?>" href="app/index/transaksi_management_master_plan">Management Master Plan RLA</a>
                                   <a class="<?=($pg == "transaksi_timeline_rla" ? "active" : "")?>" href="app/index/transaksi_timeline_rla">Timeline RLA</a>
                                   <a class="<?=($pg == "transaksi_monitoring_pengadaan" ? "active" : "")?>" href="app/index/transaksi_monitoring_pengadaan">Monitoring Pengadaan & Kontak</a>
                                   <a class="<?=($pg == "transaksi_catatan_rla" ? "active" : "")?>" href="app/index/transaksi_catatan_rla">Catatan RLA</a>
                                   <a class="<?=($pg == "transaksi_pengukuran" ? "active" : "")?>" href="app/index/transaksi_pengukuran">Pengukuran</a>
                                 <!--   <a class="<?=($pg == "transaksi_detail_pengukuran" ? "active" : "")?>" href="app/index/transaksi_detail_pengukuran">Detail Pengukuran</a> -->
                                   <a class="<?=($pg == "transaksi_site_visit" ? "active" : "")?>" href="app/index/transaksi_site_visit">Site Visit</a>
                                </li>
                            </ul>
                        </li>

                        <li class="nav-item <?=(stristr($pg, "setting_") ? "menu-is-opening menu-open" : "")?>">
                            <a href="#" class="nav-link <?=(stristr($pg, "setting_") ? "active" : "")?>"><strong>Setting</strong> 
                            <span class="<? if($pg == "" || $pg == "home"){ ?>caret<? } else {?>arrow-right<? } ?>"></span></a>
                            <ul class="nav nav-treeview">

                                <li class="nav-item">
                                    <a class="<?=($pg == "setting_crud" ? "active" : "")?>" href="app/index/setting_crud">Master CRUD</a>
                                    <a class="<?=($pg == "setting_role_approval" ? "active" : "")?>" href="app/index/setting_role_approval">Role Approval</a>
                                    <a class="<?=($pg == "setting_flow_approval" ? "active" : "")?>" href="app/index/setting_flow_approval">Flow Approval</a>
                                </li>
                            </ul>
                        </li>

                       <!--  <li class="nav-item">
                            <a href="#" class="nav-link <?=(stristr($pg, "coba_") ? "active" : "")?>"><strong>Coba</strong> 
                            <span class="caret"></span></a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="#" class=" <?=(stristr($pg, "coba_") ? "active" : "")?>"><strong>Coba Anak</strong><span class="caret"></span></a>
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                        <a class="<?=($pg == "setting_crud" ? "active" : "")?>" href="app/index/setting_crud">Master CRUD</a>
                                        </li>
