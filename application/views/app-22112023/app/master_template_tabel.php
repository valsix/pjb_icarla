...
$arrtabledata= array(
    ...
    , array("label"=>"Nama Tipe", "field"=> "NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Total", "field"=> "TOTAL", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"PENGUKURAN_CHECK", "field"=> "PENGUKURAN_CHECK", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"fieldid", "field"=> "TABEL_TEMPLATE_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<script type="text/javascript">
    ...
    $("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_template_tabel_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_template_tabel_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("app/index/master_template_tabel_import");
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        if(valcheckhapus == 1)
        {
            $.messager.alert('Info', "Data tidak bisa dihapus, data sudah dipakai di pengukuran", 'warning');
             return false;
        }

        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/template_tabel_json/delete/?reqId="+valinfoid,
                    function(data){
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/template_tabel_json/json?reqPencarian="+reqPencarian;
    ...
    $("#btnCopy").on("click", function () {
        ...
        $.messager.confirm('Konfirmasi',"Copy data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/template_tabel_json/copymaster/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/template_tabel_json/json";
