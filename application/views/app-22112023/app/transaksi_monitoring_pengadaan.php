...
$arrtabledata= array(
    ...
    , array("label"=>"Kode Masterplan RLA", "field"=> "KODE_MASTER_PLAN", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Nama Vendor", "field"=> "NAMA_VENDOR", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Judul Kontrak", "field"=> "JUDUL_KONTRAK", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Tanggal Kontrak", "field"=> "TANGGAL_KONTRAK", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"fieldid", "field"=> "PENGADAAN_KONTRAK_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<div class="col-md-12">
    ...
    <div class="konten-area">
            ...
            <ul class="nav nav-pills mr-auto">
                ...
                if(!empty($reqIdRla))
                {
                    ...
                    <li class="nav-item active">
                        <a class="nav-link active"  href="app/index/transaksi_monitoring_pengadaan?reqIdRla=<?=$reqIdRla?>&reqLihat=<?=$reqLihat?>"> &nbsp;Monitoring Pengadaan & Kontrak</a>
                    </li>
                    <li class="nav-item">
        ...
        <?
        if($reqMenuUmro == 1 && empty($reqFinish))
        {
        ?>  
...
<script type="text/javascript">
    ...
    $("#btnEdit").on("click", function () {
        ...
        varurl= "app/index/transaksi_monitoring_pengadaan_add?reqId="+valinfoid+"&reqIdRla=<?=$reqIdRla?>";
        document.location.href = varurl;
    });

    $("#btnAdd").on("click", function () {
        btnid= $(this).attr('id');
         varurl= "app/index/transaksi_monitoring_pengadaan_add?reqId=&reqIdRla=<?=$reqIdRla?>";
        document.location.href = varurl;
    });
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/transaksi_monitoring_pengadaan_add?reqId="+valinfoid+"&reqLihat=1&reqIdRla=<?=$reqIdRla?>";
        document.location.href = varurl;
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/pengadaan_kontrak_json/delete/?reqId="+valinfoid+"&reqIdRla=<?=$reqIdRla?>",
                    function(data){
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/pengadaan_kontrak_json/json?reqPencarian="+reqPencarian+"&reqIdRla=<?=$reqIdRla?>";
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/pengadaan_kontrak_json/json?reqIdRla=<?=$reqIdRla?>";
