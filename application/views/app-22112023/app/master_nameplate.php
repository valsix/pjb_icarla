...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "NAMEPLATE_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<script type="text/javascript">
    ...
    $("#btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_nameplate_add?reqId="+valinfoid;
        document.location.href = varurl;
    });

    $("#btnAdd").on("click", function () {
        btnid= $(this).attr('id');
        varurl= "app/index/master_nameplate_add?reqId=";
        document.location.href = varurl;
    });
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_nameplate_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("app/index/master_nameplate_import");
    });
    ...
    $('#btnImportDetail').on('click', function () {
        ...
        openAdd("app/index/master_nameplate_detail_import?reqId="+valinfoid);
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-app/nameplate_json/delete/?reqId="+valinfoid,
                    function(data){
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/nameplate_json/json?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/nameplate_json/json";
