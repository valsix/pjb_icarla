...
if($reqMode == "insert")
{
    $set->selectambildetil($reqId);
    $set->firstRow();
    $reqNamaDetil= $set->getField("NAMA_DETIL");
}
else
{
	$statement = " AND KELOMPOK_EQUIPMENT_ID = '".$reqId."' ";
    $set->selectByParams(array(), -1, -1, $statement);
    // echo $set->query;exit;
    $set->firstRow();
    $reqId= $set->getField("KELOMPOK_EQUIPMENT_ID");
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">  
                        <div class='control-label col-md-10' style="text-align: center;">
                            <?=$reqNamaDetil?>
                        </div>
                    </div>
                    <?
                    ...
                    <div class="form-group">  
                        <label class="control-label col-md-3">Kode Kelompok Equipment</label>
                        <div class='col-md-7'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                    ...
                    <div class="form-group">  
                        <label class="control-label col-md-3">Nama Kelompok Equipment</label>
                        <div class='col-md-7'>
                            <div class='form-group'>
                                <div class='col-md-11'>
...
function submitForm(){
    ...
    $('#ff').form('submit',{
        url:'json-app/kelompok_equipment_json/add',
        onSubmit:function(){
